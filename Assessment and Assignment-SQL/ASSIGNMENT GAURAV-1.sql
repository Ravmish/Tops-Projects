...
SELECT CONCAT_WS(' ', first_name, last_name) AS Name_, hire_date AS Start_Date FROM employees;

-- 8. Display the names and hire dates of all employees in the order they were hired. 
SELECT CONCAT_WS(' ', first_name, last_name) as Names, hire_date FROM employees ORDER BY hire_date;

-- 9. Display the names and salaries of all employees in reverse salary order. 
SELECT CONCAT_WS(' ', first_name, last_name) as Names, salary FROM employees ORDER BY salary DESC;

-- 10. Display 'ename" and "deptno" who are all earned commission and display salary in reverse order. 
SELECT CONCAT_WS(' ', first_name, last_name) as Names, department_id, salary FROM employees WHERE commission_pct IS NOT NULL ORDER BY salary DESC;
